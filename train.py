...
def main():
  ...
  if 'hourglass' in cfg.arch:
    ...
    model = get_pose_net_resnet(num_layers=int(cfg.arch.split('_')[-1]), num_classes=train_dataset.num_classes, head_conv=64)
  elif 'mobilenetv2' in cfg.arch:
    model = get_mobilenetv2(num_classes=train_dataset.num_classes, head_conv=64)
  else:
